...
一个 MCP (Model Context Protocol) Server，让 [Claude Code](https://docs.anthropic.com/en/docs/claude-code) 能够通过[飞书](https://www.feishu.cn/)与用户双向通信。

配置完成后，Claude Code 可以通过飞书私聊向你发送通知、提问并实时接收回复——不在电脑前也能掌控 AI 的工作进度。
